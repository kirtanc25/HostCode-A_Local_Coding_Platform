...
<!--    		<link rel="shortcut icon" href="../styles/favicon.ico" />-->
			...
			<script type="text/javascript" src="../js/compileGen.js"></script>
    ...
    <main class="main">
         ...
         <img src="../img/logofinal.png" alt="logo" class="logo-default">
            ...
            <div class="user">
                ...
                <div class="dropdown-menu" style="margin-top:67px;position:relative !important;top: 60px !important; left: 8px !important; ">
                    ...
                    <a class="dropdown-item" href="newide1.php?l=1">Logout</a>
                </div>
            </div>
        </header>
        ...
        <section class="content content--full">
            <div class="content__inner">
                ...
                <div class="card">
                    <div class="card-body">
                           <form action="compileGen.php" method="post" id="form">
                        <div class="row">
...
-->
                                ...
                                <div class="col-sm-4">
                                    <hr>
                                    <textarea name="input" id="input" class="form-control" rows="5" cols="3" placeholder="Input goes here..."></textarea>
                                ...
                                <div class="col-sm-5">  
                                    ...
                                    <input type="reset" value="Reset" class="btn-sll" id="reset">
                         ...
                         <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        <span id="output" class="output"></span><br>
