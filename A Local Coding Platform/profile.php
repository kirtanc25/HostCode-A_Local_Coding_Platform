...
<!--                                                <th>--------</th>-->
                                        ...
                                        <tbody>
                                            <?php  
                                                    $fet=mysqli_query($con,"select distinct pid from submissions where sname='$uname' and status=1");
                                                    for($i=0;$i<mysqli_num_rows($fet);$i++){

                                                    $data=mysqli_query($con,"select pbname from archieve where id=".mysqli_fetch_array($fet)[0]);
                                             
                                            ?><tr>
                                                <th scope="row"><?php echo $i+1; ?></th>
                                                <td><?php echo mysqli_fetch_array($data)[0] ?></td>
                                                <td>
